...
MASTER_ROOT_DISK_TYPE="${MINION_DISK_TYPE:-gp2}"
MASTER_ROOT_DISK_SIZE=${MINION_DISK_SIZE:-8}
# The minions root EBS volume size (used to house Docker images
MINION_ROOT_DISK_TYPE="${MINION_DISK_TYPE:-gp2}"
MINION_ROOT_DISK_SIZE=${MINION_DISK_SIZE:-32}
